...
%         PC_COLOR = {0.275, .337, .60, 0.5f}; // blue
        ...
        MIN_NEIGHBOR_NUM =64;%8
        MAX_NEIGHBOR_NUM =64;% orginal 30
        
        LAPLACIAN_CONSTRAINT_WEIGHT = 30; % init Laplacian contraction weight, compute automatically now.
        POSITION_CONSTRAINT_WEIGHT = 5; % init position constraint weight
        ...
        CONTRACT_TERMINATION_CONDITION = 0.00001;% contract Termination Conditions for total area ratio 0.01         
    end
